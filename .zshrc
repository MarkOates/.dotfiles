...
alias gl1mh='git log --pretty=tformat:'\''%an%x09%ad%x09%C(yellow)%h%Creset%x09%s'\'' --date=short master..HEAD'
alias gl='gl1mh'
alias gla='git log --pretty=tformat:'\''%C(yellow)%h%Creset%x09%an%x09%ad%x09%s'\'' --date=short'
alias gl8='gla -8'
alias gb='git branch'
alias ga='git add'
alias gp='git pull'
